...
<section id="slider">
    ...
    <section id="about" class="  p-bottom-10 ">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <a href="{{ URL::to('/aboutus') }}"
                            class="m-top-10 m-bottom-10 btn btn-main roundbtn wow fadeInUp" data-wow-duration="0.7s"
                            data-wow-delay="0.5s">Know more</a>
                    </div> <!-- /.col -->
                        ...
                        <div class="feature-image parent">
                            <a href="{{ URL::to('/aboutus') }}">
                                ...
                                <img src="{{ URL::to('about/' . $about_contact->image) }}" alt="Feature Image"
                                    class="img-responsive wow fadeInRight img-circle image2" data-wow-duration="1s"
                                    data-wow-delay="0.6s" />
                            </a>
                        </div>
                                    ...
                                    <div class="team-item wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                                        <div class="team-item-image">
                                            <div class="team-item-image-overlay">
                                                <div class="team-item-icons">
                                                    ...
                                                    @endphp
                                                    <a href="{{ URL::to('service') . '/' . $services->nameurl }}"><img class="servicebg"
                                                            src="{{ URL::to('frontend/img/astrosignorange.png') }}">
                                                    </a>
                                                </div>
                                            </div>
                                            @php
                                            ...
                                            @endphp
                                            <a href="{{ URL::to('service') . '/' . $services->nameurl }}"><img
                                                    src="{{ URL::to('service') . '/' . $services->Image }}" alt="{{$alttag}}"
                                                    title="{{ $title }}" /></a>
                                        </div>
                                        <div class="team-item-info">
                                            <a href="{{ URL::to('service') . '/' . $services->nameurl }}">
                                                ...
                                                <div class="team-item-position p-l-20">
    ...
    <!-- End Team -->
    <section id="myjourney" class="  p-bottom-10">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <!-- Section Title -->
                    <div class="section-title text-center m-bottom-20">
                        ...
                        <div class="divider-center-small wow zoomIn" data-wow-duration="1s" data-wow-delay="0.6s"></div>
                        <p class="section-subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">Embarking
                            on a spiritual odyssey in childhood, I cultivated a deep passion for astrology and palm
                            reading. Rigorous meditation birthed my professional journey in astrology, palmistry,
                            numerology, and Vastu. Beyond providing comfort, my services reflect a life well-lived. In
                            times of joy, may we all find support. Welcome to a journey where spirituality meets
                            practical wisdom.</p>
                    </div>
                </div> <!-- /.col -->
            </div> <!-- /.row -->
    ...
    <!-- Start blog -->
    <section id="youtube" class="  p-bottom-10">
        <div class="container ">
            <div class="row">
                <div class="col-md-12">
                    <!-- Section Title -->
    ...
    <!-- Start Testimonial -->
    <section id="testimonials" class="parallax-bg overlay-dark   p-bottom-10" data-stellar-background-ratio="0.5">
        <div class="container ">
            <div class="row">
                <div class="col-md-12">
                    <!-- Section Title -->
                    <div class="section-title text-center white-color m-bottom-20">
                        <h1 class="wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.6s">Happy Client
                            Testimonials</h1>
                        <div class="divider-center-small divider-white wow zoomIn" data-wow-duration="1s"
                    ...
                    <div id="owl-testimonials" class="owl-carousel owl-theme testimonial text-center white-color ">
                        @foreach ($reviews as $review)
                            ...
                            <div class="testimonial-item text-center">
                                <p class="testimonial-desc "><i class="fa fa-quote-right fa-flip-horizontal"
                                        aria-hidden="true"></i> {{ $review->review}}<i class="fa fa-quote-right"
    ...
    <!-- Start blog -->
    <section id="blog" class="  p-bottom-10">
        <div class="container ">
            <div class="row">
                <div class="col-md-12">
                    <!-- Section Title -->
                        ...
                        @foreach ($blogitems as $blog)
                                                ...
                                                <div class="blog wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
                                                    ...
                                                    <div class="blog-post-body">
                                                        ...
                                                        <a href="{{ URL::to('/blog') . '/' . $blog['nameurl'] }}" class="read-more">Read More
                                                            >></a>
                                                    </div><!--post body-->
                                                </div> <!-- /.blog -->
                        @endforeach
                            ...
                            <form class="user" id="contactusform" method="POST" action="{{ URL::to('addcontactus') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 contact-form-item wow zoomIn">
                                        <input name="fullname" id="name" type="text" placeholder="Your Name: *"
                                            required />
