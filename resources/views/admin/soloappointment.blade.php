                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button btn-secondary " type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="true" aria-controls="flush-collapseOne" style="background:#d9e3ef;">
                                ...
                                <div class="row">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item"> Whatsapp Number :
                                            <a href="https://wa.me/91{{$appointment->whatsappNumber}}?text=Thank%20you%20behalf%20of%20Astro%20Achariya%20debdutta%20for%20connecting%20with%20us">{{ $appointment->whatsappNumber }}</a>
                                        </li>
                                        ...
                                        <li class="list-group-item"> Date Of Birth : {{ $appointment->dateOfBirth }} </li>
                                        <li class="list-group-item"> Place Of Birth : {{ $appointment->placeOfBirth }} </li>
                                        <li class="list-group-item"> State Of Birth : {{ $appointment->stateOfBirth }} </li>
                                        <li class="list-group-item"> Time Of Birth : {{ $appointment->timeOfBirth }} </li>
