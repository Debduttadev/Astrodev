                                ...
                                <div class="row">
                                    <form action="{{ URL::to('updatehoroscope') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="dailyscope" name="files[]" class="form-control dailyhoroscopefile" multiple>
                                            <p class="help-block">Note: Supported image format: .jpeg, .jpg, .png, .gif</p>
                                        </div>
                                        <button type="submit" class="btn btn-primary dailyhoroscopesubmit">Submit</button>
                                    </form>
                                </div>
                                <div>
