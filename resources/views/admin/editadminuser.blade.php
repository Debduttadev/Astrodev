        ...
        <div class="row">
            ...
            <form method="POST" action="{{ URL::to('updateadminuser') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password" class="form-control form-control-solid" type="password" name="password" maxlength="10" required autocomplete="new-password" aria-placeholder="**********" />
