    ...
    (function (c) {
        ...
        c.widget.prototype = {
            ...
            _trigger: function (l, m, n) {
                ...
                return !(
                    (c.isFunction(p) &&
                        p.call(this.element[0], m, n) === false) ||
            ...
            _mouseUp: function (j) {
                ...
                if (this._mouseStarted) {
                    ...
                    this._preventClickEvent =
                        j.target == this._mouseDownEvent.target;
                    this._mouseStop(j);
                }
                return false;
            },
            ...
            _setContainment: function () {
                ...
                if (e.containment == "document" || e.containment == "window") {
                    this.containment = [
                        ...
                        a(
                            e.containment == "document" ? document : window
                        ).width() -
                            this.helperProportions.width -
                            this.margins.left,
                        (a(
...
(function (c) {
                ...
                if (this.handles.constructor == String) {
                    ...
                    for (var f = 0; f < k.length; f++) {
                        var h = c.trim(k[f]),
                            d = "ui-resizable-" + h;
                        var g = c(
                            '<div class="ui-resizable-handle ' + d + '"></div>'
                        );
                    ...
                    g.css({
                        height:
                            f.height() -
                                ...
                                this.borderDif[2] || 0,
                        width:
                            f.width() - this.borderDif[1] - this.borderDif[3] ||
                            0,
                    });
                }
            },
    ...
    c.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (f, p) {
            ...
            if (m.top < (s._helper ? n.top : 0)) {
                s.size.height =
                    s.size.height +
                    (s._helper ? s.position.top - n.top : s.position.top);
                if (q) {
            ...
            var k = Math.abs(
                    (s._helper
                        ...
                        : s.offset.left - d.left) + s.sizeDiff.width
                ),
                r = Math.abs(
    ...
    c.ui.plugin.add("resizable", "grid", {
        resize: function (d, l) {
            ...
            var f =
                    Math.round((j.width - h.width) / (g.grid[0] || 1)) *
                    (g.grid[0] || 1),
                e =
    ...
    a.widget(
        ...
        a.extend({}, a.ui.mouse, {
                ...
                if (this.options.scroll) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                f.pageY - this.overflowOffset.top <
                                g.scrollSensitivity
                            ) {
                                this.scrollParent[0].scrollTop = b =
                        ...
                        if (
                            ...
                            if (
                                f.pageX - this.overflowOffset.left <
                                g.scrollSensitivity
                            ) {
                                this.scrollParent[0].scrollLeft = b =
            ...
            serialize: function (d) {
                ...
                a(b).each(function () {
                    var e = (
                        a(d.item || this).attr(d.attribute || "id") || ""
            ...
            _getItemsAsjQuery: function (b) {
                            ...
                            if (f && f != this && !f.options.disabled) {
                                e.push([
                                    a.isFunction(f.options.items)
                                        ...
                                        : a(f.options.items, f.element).not(
                                              ".ui-sortable-helper"
                                          ),
                                    f,
                                ]);
                ...
                e.push([
                    a.isFunction(this.options.items)
                        ...
                        : a(this.options.items, this.element).not(
                              ".ui-sortable-helper"
                          ),
                    this,
                ]);
    ...
    (function (d) {
                ...
                return this.each(function () {
                    ...
                    for (var r in m) {
                        if (
                            ...
                            (r.match(/color/i) ||
                                (!r.match(/color/i) &&
                                    !isNaN(parseInt(m[r], 10)))) &&
                            (l.position != "static" ||
                                (l.position == "static" &&
                                    !r.match(/left|top|bottom|right/)))
                        ) {
                            q[r] = m[r];
                        }
                    }
        ...
        d.fn.extend({
            ...
            removeClass: function (g, f, i, h) {
                return f
                    ? d.effects.animateClass.apply(this, [
                          { remove: g },
                          f,
                          i,
                          h,
        ...
        function b(g) {
            ...
            if (
                (f = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(
                    g
                ))
            ) {
                return [
        ...
        d.extend(d.easing, {
            ...
            easeOutBounce: function (g, h, f, j, i) {
                if ((h /= i) < 1 / 2.75) {
                    ...
                    if (h < 2 / 2.75) {
                        ...
                        if (h < 2.5 / 2.75) {
                            return (
                                j * (7.5625 * (h -= 2.25 / 2.75) * h + 0.9375) +
                                f
                            );
                        } else {
                            return (
                                j *
                                    (7.5625 * (h -= 2.625 / 2.75) * h +
                                        0.984375) +
                                f
                            );
                        }
            ...
            easeInOutBounce: function (g, h, f, j, i) {
                ...
                return (
                    d.easing.easeOutBounce(g, h * 2 - i, 0, j, i) * 0.5 +
                    j * 0.5 +
                    f
                );
            },
...
(function (a) {
    a.effects.puff = function (b) {
        return this.queue(function () {
            ...
            var d = g / 100;
            f.from =
                h == "hide" ? e : { height: e.height * d, width: e.width * d };
            c.from = f.from;
    ...
    a.effects.scale = function (b) {
        return this.queue(function () {
            ...
            g.from =
                b.options.from || (j == "show" ? { height: 0, width: 0 } : f);
            var e = {
            ...
            if (e.fillSpace) {
                ...
                this.headers
                    ...
                    .each(function () {
                        c = Math.max(
                            c,
                            a(this).innerHeight() - a(this).height()
                        );
                    })
        ...
        animations: {
            slide: function (j, h) {
                ...
                a.each(e, function (k, m) {
                    f[m] = "hide";
                    var l = ("" + a.css(j.toShow[0], m)).match(
                        /^([\d+-.]+)(.*)$/
                    );
    ...
    c.widget("ui.dialog", {
            ...
            this.uiDialog
                .resizable({
                    ...
                    start: function () {
                        ...
                        f.resizeStart &&
                            f.resizeStart.apply(d.element[0], arguments);
                    },
                    resize: function () {
                    ...
                    stop: function () {
                        ...
                        f.resizeStop &&
                            f.resizeStop.apply(d.element[0], arguments);
                        c.ui.dialog.overlay.resize();
                    },
                })
        ...
        _position: function (i) {
            var e = c(window),
                ...
                h = g;
            if (
                c.inArray(i, ["center", "top", "right", "bottom", "left"]) >= 0
            ) {
                i = [
        ...
        _setData: function (e, f) {
            ...
            switch (e) {
                ...
                case "resizable":
                    ...
                    g &&
                        typeof f == "string" &&
                        d.resizable("option", "handles", f);
                    g || this._makeResizable(f);
                    break;
                case "title":
                    c(".ui-dialog-title", this.uiDialogTitlebar).html(
                        f || "&nbsp;"
                    );
                    break;
                case "width":
        ...
        a.extend({}, a.ui.mouse, {
            _init: function () {
                ...
                if (c.values && c.values.length) {
                    while (
                        a(".ui-slider-handle", this.element).length <
                        c.values.length
                    ) {
                        a('<a href="#"></a>')
                            .appendTo(this.element)
                ...
                if (this.options.values && this.options.values.length) {
                    ...
                    this.handles.each(function (p, n) {
                        var o =
                            ...
                            100;
                        var m = {};
                        m[l.orientation == "horizontal" ? "left" : "bottom"] =
                            o + "%";
                    ...
                    var j = this.value(),
                        ...
                        e = k != g ? ((j - g) / (k - g)) * 100 : 0;
                    var b = {};
                    b[l.orientation == "horizontal" ? "left" : "bottom"] =
                        e + "%";
    ...
    a.widget("ui.tabs", {
        ...
        _tabify: function (n) {
            ...
            if (n) {
                ...
                d.selected =
                    (d.selected >= 0 && this.anchors[d.selected]) ||
                    d.selected < 0
                        ? d.selected
                        : 0;
                d.disabled = a
